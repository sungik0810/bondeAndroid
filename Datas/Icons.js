...
const IconImage = ({name,uri=String}) => {
    const socialIcon = uri === "Apple" ? require("../asset/icons/socialLoginIcons/appleLogo.svg") : uri === "Google" ? require("../asset/icons/socialLoginIcons/googleLogo.svg") : uri ===  "Kakao" ? require("../asset/icons/socialLoginIcons/kakaoLogo.svg") : null
    ...
    resizeMode={FastImage.resizeMode.contain}/>):
    name === "socialLogin" ? (<WithLocalSvg asset={socialIcon}/>):
