...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    ...
    <View style={{width:"100%",marginBottom:8}}>
      <View style={{marginLeft:16,marginRight:16,backgroundColor:"white",borderRadius:8,aspectRatio:16/5}}>
    ...
    {/* FullSizeButton */}
    <View style={{width:"100%",marginBottom:8}}>
      <TouchableOpacity  style={{marginLeft:16,marginRight:16,backgroundColor:"white",borderRadius:8,width:windowWidth-32,height:156}}
      onPress={()=>{
    ...
    {/* new Store */}
    <View style={{backgroundColor:"white",marginBottom:8,borderTopWidth:1,borderBottomWidth:1,borderColor:"#D9D9D9"}}>
    <FontStyle text="새로운 가게" size="xLarge" fontWeight="900" marginLeft={16} marginTop={8} marginBottom={8}/>
    <ScrollView horizontal={true}>
      <View style={{flexDirection:"row",marginLeft:16}}>
      <TouchableOpacity style={{marginRight:16,marginBottom:8}}>
        <LogoStyle src={<IconImage name="mini"/>} size="big"/>
        <FontStyle text="가게 이름" size="small" fontWeight="600" marginTop={4} marginBottom={4} />
